      ...
      return (
        <div>
          <Link href="/api/auth/signin">
            <button className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-white font-bold items-center justify-center hover:bg-purple-600 hover:text-white'
              onClick={(e) => {
                e.preventDefault();
              signIn();
            }}
